...
import { useRegisterUser } from "@/apis/auth"
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-0">
      <div className="flex flex-col lg:flex-row w-full max-w-[1440px] lg:h-screen lg:overflow-hidden bg-white shadow-sm rounded-2xl overflow-hidden">
        ...
        {/* Form Section */}
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-white overflow-y-auto order-2 lg:order-1">
          <div className="w-full max-w-md space-y-6 py-6 lg:py-0">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Join our community and start your journey towards financial enlightenment!
              </p>
            </div>
                  ...
                  children={(field) => {
                    ...
                    return (
                      <Field data-invalid={isInvalid} className="space-y-1">
                        <FieldLabel htmlFor={field.name} className="text-sm font-semibold text-gray-700">Username</FieldLabel>
                        <Input
                          id={field.name}
                          name={field.name}
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            <blockquote className="space-y-4">
              <p className="text-2xl font-medium leading-relaxed">
                "Join thousands of users who have taken control of their financial destiny with Faving."
              </p>
